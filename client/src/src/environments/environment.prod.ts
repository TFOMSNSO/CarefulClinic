...
secondory_inform:'повторное информирование',
  nstage_4_str: 'информирование о проф. осмотрах',
  nstage_5_str: 'информирован о Д-учете',
  nstage_6_str: 'информирование о прохождении 1 раз в 2 года',
  nstage_7_str: 'повторное информирование о прохождении 1 раз в 2 года',
  nstage_8_str: 'повторное информирование о Д-учете',
  nstage_9_str: 'повторное информирование о проф. осмотрах',
  nstage_10_str: 'об отмене диспансеризации и ПМО',
  nstage_11_str: 'об особенностях поведения во время КВИ граждан из групп риска',
  nstage_12_str: 'о получении медицинской помощи ЗЛ, состоящих на ДУ',
...
statsurvey20:'Не знал',
 ...
 menu_main_page:'Главная страница',
  ...
  report_inform_all:'Подлежащие информированию за текущий год',
  ...
  menu_admin_inform_allyear:'Сформировать информирование за текущий год',
